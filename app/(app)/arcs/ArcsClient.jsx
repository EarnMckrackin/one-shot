...
const s = {
  ...
  createBtn:   { background: C.accent, color: "#fff", padding: "10px 20px", borderRadius: 10, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" },
  msg:         { color: C.textSoft, padding: "40px 0" },
  sectionHead: { color: C.textSoft, fontSize: 12, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 12 },
  grid:        { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: 12 },
  arcCard:     { background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: 18, display: "flex", flexDirection: "column", gap: 8 },
  arcTop:      { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 },
  arcName:     { color: C.text, fontWeight: 700, fontSize: 15, lineHeight: 1.3 },
  systemTag:   { background: C.surface, color: C.gold, fontSize: 10, fontWeight: 700, padding: "2px 7px", borderRadius: 10, letterSpacing: 0.5, flexShrink: 0 },
  arcDesc:     { color: C.textFaint, fontSize: 12, lineHeight: 1.5, flex: 1 },
  arcBottom:   { display: "flex", alignItems: "center", gap: 10, marginTop: 4 },
  progressBar: { flex: 1, height: 4, background: C.border, borderRadius: 2, overflow: "hidden" },
  progressFill:{ height: "100%", background: C.cyan, borderRadius: 2 },
  arcMeta:     { color: C.textFaint, fontSize: 11, flexShrink: 0 },
};
